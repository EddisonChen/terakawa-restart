        ...
        <div>
          ...
          <div className="first-part">
            <div className="money-input">
              <div>
                <h3>Lunch</h3>
                <input type="tel" mode="numeric" placeholder="Lunch Credit" name="lunchCredit" onChange={getValue}></input>
                <input type="tel" mode="numeric" placeholder="Lunch Cash" name="lunchCash" onChange={getValue}></input>
                <p>Lunch Total: ${lunchTotal}</p>
              </div>
              <div>
                <h3>Dinner</h3>
                <input type="tel" mode="numeric" placeholder="Dinner Credit" name="dinnerCredit" onChange={getValue}></input>
                <input type="tel" mode="numeric" placeholder="Dinner Cash" name="dinnerCash" onChange={getValue}></input>
          ...
          <div className="worker-percent">
            <div className="lunch-percent">
              <h3>Lunch</h3>
              <input type="tel" mode="numeric" placeholder="Worker 1 %" name="worker1" onChange={setLunchWorkerPercent} ></input>
              <input type="tel" mode="numeric" placeholder="Worker 2 %" name="worker2" onChange={setLunchWorkerPercent}></input>
            ...
            <div className="dinner-percent">
              <h3>Dinner</h3>
              <input type="tel" placeholder="Worker 1 %" name="worker1" className="dinner-input" onChange={setDinnerWorkerPercent}></input>
              <input type="tel" placeholder="Worker 2 %" name="worker2" className="dinner-input" onChange={setDinnerWorkerPercent}></input>
              <input type="tel" placeholder="Worker 3 %" name="worker3" className="dinner-input" onChange={setDinnerWorkerPercent}></input>
              <div className="tip-results">
                <div className="tip-results-specific">
                  <h4>Credit</h4>
